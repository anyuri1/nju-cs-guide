...
这不是第二份培养方案，也不打算把专业课再讲一遍。

它只做一件事：当你知道自己缺什么时，告诉你去哪里找。链接按“官方通知、课程主页、原作者文档、社区整理”的顺序选择；会变的政策，只给入口，不替学校作解释。

> 面向南京大学计算机学院本科生 ｜ 链接最近核验于 **2026-09-18**
> 政策类内容只保证指向官方入口，不保证仍然有效——以你看到时的官方页面为准。
...
链接会失效，政策会变，人的经验也有适用范围。遇到这三件事，请相信发布日期更近的官方页面。

发现错漏，见 [CONTRIBUTING.md](CONTRIBUTING.md)。文档采用 [CC BY-NC-SA 4.0](LICENSE) 许可。
